...
**single-chain bulk TCR-sequencing data**.
...
A simple **new algorithm (T-SHELL)** allows for **effective pairing of
the most abundant clones**, which had frustrated previous algorithms.
Along with paired TCR information, single-chain read frequency can be
used to identify expanded clones in one sample as well as to track clone
expansions and contractions longitudinally across samples.
