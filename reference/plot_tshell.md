...
- data (list)
  ...
  - df_all - a data frame with results for all potential partners
    passing the `loss_frac_cutoff`
...
- plots (list)
  ...
  - scatter - a scatter plot of read fractions for the input chain vs.
    the top N potential partner chains
  ...
  - rank_vs_p_adj - a Manhattan plot of chain rank vs. -log10(FDR
    adjusted p-value)
