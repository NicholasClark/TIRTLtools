...
- The TIRTL-seq assay paper has been published in *Nature Methods*: <br> [**TIRTL-seq: deep, quantitative and affordable paired TCR repertoire sequencing**](http://doi.org/10.1038/s41592-025-02907-9).
...
- 384-well TIRTL-seq protocol: https://www.protocols.io/view/tirtl-seq-384-well-eq2lyx37wgx9/
- 96-well TIRTL-seq protocol: https://www.protocols.io/view/tirtl-seq-96-well-kqdg3k6xpv25/

## Bug reports

For any bug reports or new feature requests, please create a GitHub Issue:

- https://github.com/NicholasClark/TIRTLtools/issues

## References

For details on our pairing pipeline, see the [**TIRTL-seq paper (Pogorelyy and Kirk et al., *Nature Methods* 2025)**](http://doi.org/10.1038/s41592-025-02907-9) and our [github repository](https://github.com/pogorely/TIRTL).

For a summary of the TIRTL-seq method and its importance, see the *Immunology News & Views* article in *Nature Methods* highlighting TIRTL-seq: [**TIRTL-seq: heroes with T-SHELL**](https://doi.org/10.1038/s41592-025-02984-w).
...
- Pogorelyy, M.V., Kirk, A.M., Adhikari, S. *et al.* TIRTL-seq: deep, quantitative and affordable paired TCR repertoire sequencing. *Nat Methods* 23, 56–64 (2026). https://doi.org/10.1038/s41592-025-02907-9

If using the 384-well or 96-well TIRTL-seq protocol, please cite the *protocols.io* protocols:

- Mikhail Pogorelyy, Allison Kirk, Samir Adhikari, Balaji Sundararaman, Paul Thomas 2025. TIRTL-seq 384-well. *protocols.io*
https://dx.doi.org/10.17504/protocols.io.eq2lyx37wgx9/

- Mikhail Pogorelyy, Allison Kirk, Samir Adhikari, Balaji Sundararaman, Paul Thomas 2025. TIRTL-seq 96-well. *protocols.io*
